...
public:
  ...
  // fmt/quill
  template <typename... Args> void info_fast(const char *fmt, Args &&...args) {
    info(fmtquill::vformat(fmt, fmtquill::make_format_args(args...)));
  }
  template <typename... Args> void warn_fast(const char *fmt, Args &&...args) {
    warn(fmtquill::vformat(fmt, fmtquill::make_format_args(args...)));
  }
  template <typename... Args> void error_fast(const char *fmt, Args &&...args) {
    error(fmtquill::vformat(fmt, fmtquill::make_format_args(args...)));
  }
  template <typename... Args> void debug_fast(const char *fmt, Args &&...args) {
